...
int main(int argc, char *argv[])
{
	...
	if (zconf.destination_cidrs && zconf.blacklist_filename &&
		...
		log_warn(
		    ...
		    "at /etc/zmap/blacklist.conf. By default, this blacklist excludes "
		    "locally "
		    "scoped networks (e.g. 10.0.0.0/8, 127.0.0.1/8, and "
		    "192.168.0.0/16). If you are"
		    " trying to scan local networks, you can change the default "
		    "blacklist by "
