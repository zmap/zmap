/*
  ...
  gengetopt -C --no-help --no-version -i /Users/jhart/rapid7/zmap/src/zitopt.ggo -F /Users/jhart/rapid7/zmap/src/zitopt 
...
#include "/Users/jhart/rapid7/zmap/src/zitopt.h"

const char *gengetopt_args_info_purpose = "A tool iterating of the IPv4 space";

const char *gengetopt_args_info_usage = "Usage: ziterate [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->shards_help = gengetopt_args_info_help[8] ;
  args_info->shard_help = gengetopt_args_info_help[9] ;
  args_info->help_help = gengetopt_args_info_help[11] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "b:w:l:v:e:hV", long_options, &option_index);
