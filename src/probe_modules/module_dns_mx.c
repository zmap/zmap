...
void dns_process_packet(const void *packet, UNUSED uint32_t len, fieldset_t *fs) {
...
//        
//        //27 bytes
//        data = malloc(sizeof(char)*(ip_len - 69));
//        //fs_add_uint64(fs, "answers", data);
        fs_add_binary(fs, "answers", (ip_len-42), (void *)&ptr[0], 0);
        //memcpy(data, (ptr+14), ip_len-35);
        //fs_add_binary(fs, "answers", ip_len-35, data, 0);
