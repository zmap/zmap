...
zmap - program to do something

# SYNOPSIS

**zmap** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**zmap** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **zmap** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**zmap** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    zmap. See **foo.conf**(5) for further details.
...
**zmap** provides some return codes, that can be used in scripts:
...
Phillip Stephens <phillip@cs.stanford.edu>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Phillip Stephens
